...
export type ParentMessage =
  | { type: 'start'; agentId: string; runId: string; trigger: TriggerType; input?: string; resume?: boolean; images?: IpcImage[]; tools?: string[]; secrets?: Record<string, string>; sharedSecrets?: string[] | null; schedule?: string }
