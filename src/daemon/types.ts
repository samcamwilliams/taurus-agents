...
export type ParentMessage =
  | { type: 'start'; agentId: string; runId: string; trigger: TriggerType; input?: string; resume?: boolean; images?: IpcImage[]; messageMeta?: MessageMeta; tools?: string[]; secrets?: Record<string, string>; sharedSecrets?: string[] | null }
  ...
  | { type: 'spawn_result'; requestId: string; summary: string; runId?: string; error?: string }
